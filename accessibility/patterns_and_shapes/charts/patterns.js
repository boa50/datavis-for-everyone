const addPattern = (svg, id, width, height, path) => {
    svg
        .append('defs')
        .append('pattern')
        .attr('id', id)
...
export const addWavesPattern = svg => {
    const id = 'wavesPattern'
...
export const addCrossPattern = svg => {
    const id = 'crossPattern'
...
export const addTrianglePattern = svg => {
    const id = 'trianglePattern'
...
export const addScalesPattern = svg => {
    const id = 'scalesPattern'
