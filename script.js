...
const links = [
    ...
    { txt: 'Hidden Information', url: './hidden-information/index.html', dateUpdated: new Date(2024, 7, 28) },
    { txt: 'Accessibility', url: './accessibility/index.html', dateUpdated: new Date(2024, 6, 8) },
